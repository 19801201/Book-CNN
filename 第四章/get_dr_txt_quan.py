...
from yolo_quan import YOLO
from nets.yolo4_tiny_quan1 import YoloBody
from PIL import Image, ImageFont, ImageDraw
from utilsz.utils import non_max_suppression, bbox_iou, DecodeBox, letterbox_image, yolo_correct_boxes
...
for image_id in tqdm(image_ids):
    ...
    # 开启后在之后计算mAP可以可视化
    # image.save("./input/images-optional/"+image_id+".bmp")
