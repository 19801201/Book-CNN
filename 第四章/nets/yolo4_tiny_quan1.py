...
class YoloBody(nn.Module):
    def __init__(self, num_anchors, num_classes):
        ...
        self.conv1 = BasicConv(1, 16, kernel_size=3, stride=2)
        self.conv2 = BasicConv(16, 32, kernel_size=3, stride=2)
        ...
        # 13,13,512 -> 13,13,512
        self.conv3 = BasicConv(256, 256, kernel_size=3)
        ...
        self.yolo_headP5 = yolo_head([256, num_anchors * (5 + num_classes)], 128)

        self.upsample = Upsample(128, 64)
        self.yolo_headP4 = yolo_head([128, num_anchors * (5 + num_classes)], 192)
